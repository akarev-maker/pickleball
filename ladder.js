...
export const ROSTER = [
  {
    ...
    speed: 8, reaction: 0.5, aimError: 4.5, dinkiness: 0.1, aggression: 0.1, lobbiness: 0.15,
  },
  {
    ...
    speed: 8.5, reaction: 0.42, aimError: 2.2, dinkiness: 0.8, aggression: 0.05, lobbiness: 0.1,
  },
  {
    ...
    speed: 10, reaction: 0.35, aimError: 3, dinkiness: 0.25, aggression: 0.1, lobbiness: 0.75,
  },
  {
    ...
    speed: 11, reaction: 0.3, aimError: 2.8, dinkiness: 0, aggression: 0.9, lobbiness: 0,
  },
  {
    ...
    speed: 12, reaction: 0.25, aimError: 2.6, dinkiness: 0.4, aggression: 0.35, lobbiness: 0.15,
  },
  {
    ...
    speed: 12.5, reaction: 0.2, aimError: 2.1, dinkiness: 0.8, aggression: 0.25, lobbiness: 0.1,
  },
  {
    ...
    speed: 14, reaction: 0.16, aimError: 2.2, dinkiness: 0.3, aggression: 0.3, lobbiness: 0.25,
  },
  {
    ...
    speed: 15, reaction: 0.1, aimError: 1.6, dinkiness: 0.5, aggression: 0.55, lobbiness: 0.1,
  },
];
...
export const QUICK_PROFILES = {
  easy: {
    ...
    speed: 9, reaction: 0.45, aimError: 4, dinkiness: 0.35, aggression: 0.2, lobbiness: 0.2,
  },
  medium: {
    name: 'Medium CPU', color: '#ff8a5e',
    speed: 12, reaction: 0.25, aimError: 3, dinkiness: 0.45, aggression: 0.35, lobbiness: 0.15,
  },
  hard: {
    name: 'Hard CPU', color: '#ff8a5e',
    speed: 14, reaction: 0.12, aimError: 1.8, dinkiness: 0.5, aggression: 0.5, lobbiness: 0.15,
  },
};
